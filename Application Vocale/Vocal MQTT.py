...
# Initialiser le client MQTT (mais ne pas le connecter immédiatement)
client = mqtt.Client()
...
def connecter_mqtt():
    ...
    try:
        ...
        global MQTT_TOPIC  # Rendre le sujet accessible globalement
...
def ecouter_microphone():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            # Publier le texte reconnu sur MQTT
...
port_entry.insert(0, "1883")  # Port par défaut
