...
class MQTTApp:
    def __init__(self, root):
        self.root = root
        self.root.title("MQTT Application")
        ...
        self.add_label_and_entry(self.config_frame, "MQTT Broker Address:", 0, "broker_ip")
        self.add_label_and_entry(self.config_frame, "Port (default 1883):", 1, "broker_port", default="1883")
        self.add_label_and_entry(self.config_frame, "Topic:", 2, "topic")
        self.add_label_and_entry(self.config_frame, "Username:", 3, "username")
        self.add_label_and_entry(self.config_frame, "Password:", 4, "password", show="*")
        ...
        # Message input field
        self.message_label = tk.Label(root, text="Message to send:", bg="#f0f2f5", font="Helvetica 12 bold")
        ...
        self.message_type_label = tk.Label(root, text="Message type:", bg="#f0f2f5", font="Helvetica 12 bold")
        ...
        # Buttons
        self.connect_button = tk.Button(root, text="Connect", command=self.connect_to_broker, bg="#007bff",
                                        fg="white", font="Helvetica 12 bold", relief="groove")
        self.connect_button.grid(row=4, column=0, padx=10, pady=10, sticky="ew")

        self.send_button = tk.Button(root, text="Send Message", command=self.send_message, bg="#28a745", fg="white",
                                     font="Helvetica 12 bold", relief="groove")
        self.send_button.grid(row=4, column=1, padx=10, pady=10, sticky="ew")

        # Button to open a new window
        self.new_window_button = tk.Button(root, text="Robot Action", command=self.open_new_window,
                                           bg="red", fg="white", font="Helvetica 12 bold", relief="groove")
    ...
    def open_new_window(self):
        ...
        # Dropdown menu for actions (Move, Rotate, Pickup, etc.)
        ...
        # Hide angle field by default
        self.angle_label.pack_forget()
        self.angle_entry.pack_forget()

        # Hide direction and distance fields for Rotate action
        ...
        # Bind the action choice update to the dropdown selection
        ...
        # Button to send action via MQTT
    ...
    def send_action(self):
        ...
        if topic:
            ...
            self.log_message("Error: Topic is not defined.")
