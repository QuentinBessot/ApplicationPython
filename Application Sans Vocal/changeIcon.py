...
class MQTTApp:
    def __init__(self, root):
        ...
        # Définir l'icône de l'application (assurez-vous que le fichier est dans le bon format et chemin)
        icon = "C:/Users/Quentin/Downloads/th.ico"  # Chemin du fichier .ico
    ...
    def stop_robot(self):
        # Créer le message JSON pour "Stop"
        ...
        if topic:
            ...
            self.log_message(f"Message 'Stop' envoyé sur le topic {topic}")
        else:
            self.log_message("Erreur : Le topic n'est pas défini.")
