...
class MQTTApp:
    def __init__(self, root, language="English"):
        ...
        # Log display frame
        self.log_frame = tk.LabelFrame(root, text=self.get_text("log_title"), bg="#f0f2f5", font="Helvetica 12 bold", padx=10, pady=10)
        ...
        # Message input field
        self.message_label = tk.Label(root, text=self.get_text("message_label"), bg="#f0f2f5", font="Helvetica 12 bold")
        ...
        self.message_type_label = tk.Label(root, text=self.get_text("message_type_label"), bg="#f0f2f5", font="Helvetica 12 bold")
        ...
        # Buttons
        self.connect_button = tk.Button(root, text=self.get_text("connect_button"), command=self.connect_to_broker, bg="#007bff",
                                        fg="white", font="Helvetica 12 bold", relief="groove")
        self.connect_button.grid(row=4, column=0, padx=10, pady=10, sticky="ew")

        self.send_button = tk.Button(root, text=self.get_text("send_message_button"), command=self.send_message, bg="#28a745", fg="white",
